...
%Times is a vector of times, note the times are expected to be in seconds,
%with each time separated by dt
%The function defaults to skipping by a "skip" amount of 50 frames. Could
%eventually make this so it changes on its own
%States is a matrix with the joint angles as the rows as a function of time
%params is the standard arms parameters structure
