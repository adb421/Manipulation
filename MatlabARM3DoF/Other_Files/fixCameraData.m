% This script was used to take vision data and remove duplicates. Since the
% camera only records data at 250Hz and the data is recorded at 1kHz, we
% "oversample" the camera and end up with something like a step function which
% makes comparing velocities and the like difficult without removing the redundant values
